              ...
              return Card(
                ...
                child: ListTile(
                  leading: SizedBox(
                    ...
                    width: 60,
                    child:
                        Image.asset(value.favouriteList[index]["productImage"]),
                  ),
                  title: Text(
                    value.favouriteList[index]["productName"],
                  ),
                  subtitle: Text(
                    value.favouriteList[index]["productRprice"],
                    style: textStyle6,
                  ),
                  trailing: IconButton(
                      onPressed: () {
                        Provider.of<ProductModel>(context, listen: false)
                            .removeProductFromFavouriteList(index);
                      },
                      icon: const Icon(
                        Icons.cancel,
